...
--EMP테이블에서 DEPNO 30 또는 10인 데이터를 조회
-- 두 테이블을 UNION으로 연결한다
SELECT * FROM EMP e 
WHERE DEPTNO =30
UNION ALL
...
SELECT PLAYER_NAME 이름 , BIRTH_DATE 생일, ROUND((SYSDATE - BIRTH_DATE)/365) 나이
FROM PLAYER p ;
...
INSERT INTO PLAYER_AGE pa 
VALUES('문준혁', '1997-09-02 00:00:00,000', 28);
